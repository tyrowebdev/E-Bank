...
@WebServlet("/ViewAllWithEditServ")
public class ViewAllWithEditServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private selectAllDAO  selectalldao ;  
  
    public ViewAllWithEditServ() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("ShowAllUsersWithEdit.jsp");
