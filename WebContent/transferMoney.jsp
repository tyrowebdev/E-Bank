...
<body>
	...
	<div id="main-content">
		...
		<div class="box">
			<h1 style="font-size: 35px; color: #009900;">Transfer Money</h1>
			<form action="TransferServ" method="post">
				<p>Your Current Balance: ${user.balance}</p>
				<h4>Enter Receiver's Details :</h4>
				<p>
					Id No. <input type="text" name="rece_id" value="">
				</p>
				<p>
					E-mail <input type="text" name="rece_email" value="">
				</p>
				<p id="hidden">
					<input type="hidden" name="sender_balance" value="${user.balance} ">
				</p>
				<p id="hidden">
