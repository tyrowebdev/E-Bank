...
<body>
	...
	<div id="main-content">
		...
		<h1>Welcome To E-Bank, Admin:${email} !</h1>
		<div class="box">
			<ul>
				<li><a href="adminUserAdd.jsp">Create New Customer</a></li>
				<li><a href="viewAllServ">View
						Customers</a></li>
				<li><a href="ViewAllWithEditServ">Edit
						Customer</a></li>
				<li><a
					href="ViewAllWithDeleteServ">Delete
						Customers</a></li>
			</ul>
		</div>
	</div>
